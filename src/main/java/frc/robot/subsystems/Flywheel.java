...
public class Flywheel extends SubsystemBase {
  ...
  private void initShootingTable() {
    addTableEntry(20.0, new FlywheelState(76, 3000, 3000));
    addTableEntry(18.0, new FlywheelState(76, 3000, 3200));
    addTableEntry(16.0, new FlywheelState(76, 3000, 3200));
    addTableEntry(14.0, new FlywheelState(76, 3000, 3200));
    addTableEntry(12.0, new FlywheelState(76, 3000, 3200));
    addTableEntry(10.0, new FlywheelState(76, 3000, 3200));
